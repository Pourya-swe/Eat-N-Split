...
- State Management - lifting state up, child to parent communication -.
- Derived State
- Rendering List
- Events
- Form handling & submission
- Workign with components, props, jsx
- The **Key** prop and its usecase here in this project - read the commnet in the code -
